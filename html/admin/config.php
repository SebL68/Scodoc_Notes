...
<body>
	...
	<main>
		...
		<div class="contenu">
			...
			-->
			<p><b>Ce menu n'est accessible qu'aux super-administrateurs et permet de changer les options de la
					passerelle.</b></p>
			...
			<details>
				...
				<div>
					...
					<label>
						...
						<p>Système interne à la passerelle pour l'analyse du trafic compatible RGPD, les données seront
							visible dans ce <a href="/services/analytics.php">tableau de bord</a>.
						</p>
						<p><b>⚠️ Exploitation des données et création des graphiques non implémentés pour le moment -
								avis aux amateurs.</b></p>
					</label>
			...
			<details>
				...
				<div>
					<label>
						...
						<p>Ca leur permet d'avoir un historique de leurs notes et également d'avoir à disposition un
							relevé intermédiaire pour les poursuites d'études.</p>
					</label>
					<label>
			...
			<details>
				...
				<div>
					<label>
						...
						<p>Ce module est spécifique à la passerelle et n'est pas connecté avec Scodoc pour le moment.
						</p>
