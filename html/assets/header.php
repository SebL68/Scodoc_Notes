<header>
	...
	<nav>
		<svg onclick="this.parentElement.parentElement.classList.toggle('ouvert')" xmlns="http://www.w3.org/2000/svg"
			width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="var(--contenu-inverse)" stroke-width="2"
		...
		<button>
			<svg width="42" height="42" stroke-width="2" viewBox="0 0 24 24" onclick="toggleTheme()" fill="none"
				id="theme-clair" xmlns="http://www.w3.org/2000/svg" stroke="var(--contenu-inverse)" stroke-width="2"
				stroke-linecap="round" stroke-linejoin="round">
				<path
			...
			<svg width="42" height="42" stroke-width="2" viewBox="0 0 24 24" onclick="toggleTheme()" fill="none"
				id="theme-sombre" xmlns="http://www.w3.org/2000/svg" stroke="var(--contenu-inverse)" stroke-width="2"
				stroke-linecap="round" stroke-linejoin="round">
				<path
