...
/**********************************/
		...
		*/
		...
		$Config->metrique_absences = $configJSON['metrique_absences'] ?? Config::$metrique_absences ?? 'heures';	// Choisir le type de métrique pour l'affichage des totaux absences aux étudiants.
