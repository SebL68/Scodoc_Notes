...
/***********************************/
	...
	$Config = new stdClass();
		...
		$Config->passerelle_version = '7:1:0';
...
/**********************************/
		...
		*/
		...
		$Config->nb_heures_conge_menstruel = $configJSON['nb_heures_conge_menstruel'] ?? Config::$nb_heures_conge_menstruel ?? 0;	// Nombre d'heures de congés menstruels autorisés.
